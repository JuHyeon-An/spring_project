...
<div id="board">
  <div class="container text-center"><h3>회원 등록</h3></div>
  <form name="frm_mm" id="frm_mm" method="post" class="row">
    ...
    <input type="button"  class="btn btn-secondary" id="btnRegister" value="저장" />
    <input type="button" class="btn btn-secondary" id="btnFind" value="취소" />
